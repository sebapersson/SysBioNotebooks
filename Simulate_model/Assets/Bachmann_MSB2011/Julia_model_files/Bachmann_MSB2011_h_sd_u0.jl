...
#p_ode_problem_names[1] = SOCS3RNATurn, p_ode_problem_names[2] = STAT5Imp, p_ode_problem_names[3] = SOCS3Eqc, p_ode_problem_names[4] = EpoRCISRemove, p_ode_problem_names[5] = STAT5ActEpoR, p_ode_problem_names[6] = SHP1ActEpoR, p_ode_problem_names[7] = JAK2EpoRDeaSHP1, p_ode_problem_names[8] = CISTurn, p_ode_problem_names[9] = SOCS3Turn, p_ode_problem_names[10] = init_EpoRJAK2_CIS, p_ode_problem_names[11] = SOCS3Inh, p_ode_problem_names[12] = ActD, p_ode_problem_names[13] = init_CIS_multiplier, p_ode_problem_names[14] = CISRNAEqc, p_ode_problem_names[15] = JAK2ActEpo, p_ode_problem_names[16] = Epo, p_ode_problem_names[17] = SOCS3oe, p_ode_problem_names[18] = CISInh, p_ode_problem_names[19] = SHP1Dea, p_ode_problem_names[20] = SOCS3EqcOE, p_ode_problem_names[21] = CISRNADelay, p_ode_problem_names[22] = init_SHP1, p_ode_problem_names[23] = CISEqcOE, p_ode_problem_names[24] = EpoRActJAK2, p_ode_problem_names[25] = SOCS3RNAEqc, p_ode_problem_names[26] = CISEqc, p_ode_problem_names[27] = SHP1ProOE, p_ode_problem_names[28] = SOCS3RNADelay, p_ode_problem_names[29] = init_STAT5, p_ode_problem_names[30] = CISoe, p_ode_problem_names[31] = CISRNATurn, p_ode_problem_names[32] = init_SHP1_multiplier, p_ode_problem_names[33] = init_EpoRJAK2, p_ode_problem_names[34] = EpoRCISInh, p_ode_problem_names[35] = STAT5ActJAK2, p_ode_problem_names[36] = STAT5Exp, p_ode_problem_names[37] = init_SOCS3_multiplier, p_ode_problem_names[38] = cyt, p_ode_problem_names[39] = nuc
...
function compute_h(u::AbstractVector, t::Real, p_ode_problem::AbstractVector, θ_observable::AbstractVector,
	...
	if observableId === :observable_CISRNA_foldA 
		...
		return u[25] * observableParameter1_observable_CISRNA_foldA / p_ode_problem[14] + 1.0 
	end
	...
	if observableId === :observable_CISRNA_foldB 
		...
		return u[25] * observableParameter1_observable_CISRNA_foldB / p_ode_problem[14] + 1.0 
	end
	...
	if observableId === :observable_CISRNA_foldC 
		...
		return u[25] * observableParameter1_observable_CISRNA_foldC / p_ode_problem[14] + 1.0 
	end
	...
	if observableId === :observable_CIS_au 
		...
		return observableParameter1_observable_CIS_au + u[22] * observableParameter2_observable_CIS_au / p_ode_problem[26] 
	end
	...
	if observableId === :observable_CIS_au1 
		...
		return u[22] * observableParameter1_observable_CIS_au1 / p_ode_problem[26] 
	end
	...
	if observableId === :observable_CIS_au2 
		...
		return u[22] * observableParameter1_observable_CIS_au2 / p_ode_problem[26] 
	end
	...
	if observableId === :observable_SOCS3RNA_foldA 
		...
		return u[5] * observableParameter1_observable_SOCS3RNA_foldA / p_ode_problem[25] + 1.0 
	end
	...
	if observableId === :observable_SOCS3RNA_foldB 
		...
		return u[5] * observableParameter1_observable_SOCS3RNA_foldB / p_ode_problem[25] + 1.0 
	end
	...
	if observableId === :observable_SOCS3RNA_foldC 
		...
		return u[5] * observableParameter1_observable_SOCS3RNA_foldC / p_ode_problem[25] + 1.0 
	end
	...
	if observableId === :observable_pEpoR_au 
		...
		return observableParameter1_observable_pEpoR_au + observableParameter2_observable_pEpoR_au * ( 16.0 * u[20] + 16.0 * u[1] + 16.0 * u[21] ) / p_ode_problem[33] 
	end
	...
	if observableId === :observable_pJAK2_au 
		...
		return observableParameter1_observable_pJAK2_au + observableParameter2_observable_pJAK2_au * ( 2.0 * u[23] + 2.0 * u[20] + 2.0 * u[1] + 2.0 * u[21] ) / p_ode_problem[33] 
	end
	...
	if observableId === :observable_pSTAT5_au 
		...
		return observableParameter1_observable_pSTAT5_au + u[2] * observableParameter2_observable_pSTAT5_au / p_ode_problem[29] 
	end
	...
	if observableId === :observable_tSHP1_au 
		...
		return observableParameter1_observable_tSHP1_au * ( u[6] + u[18] ) / p_ode_problem[22] 
	end
	...
	if observableId === :observable_tSTAT5_au 
		...
		return observableParameter1_observable_tSTAT5_au * ( u[7] + u[2] ) / p_ode_problem[29] 
	end
...
function compute_u0!(u0::AbstractVector, p_ode_problem::AbstractVector) 
	...
	SOCS3nRNA4 = 0.0 
	SOCS3RNA = 0.0 
	SHP1 = ( 1.0 + p_ode_problem[27] * p_ode_problem[32] ) * p_ode_problem[22] 
	STAT5 = p_ode_problem[29] 
	EpoRJAK2 = p_ode_problem[33] 
	CISnRNA1 = 0.0 
	SOCS3nRNA1 = 0.0 
	SOCS3nRNA2 = 0.0 
	CISnRNA3 = 0.0 
	CISnRNA4 = 0.0 
	SOCS3 = p_ode_problem[3] * p_ode_problem[20] * p_ode_problem[37] 
	CISnRNA5 = 0.0 
	SOCS3nRNA5 = 0.0 
	SOCS3nRNA3 = 0.0 
	SHP1Act = 0.0 
	...
	p12EpoRpJAK2 = 0.0 
	p2EpoRpJAK2 = 0.0 
	CIS = p_ode_problem[26] * p_ode_problem[23] * p_ode_problem[13] 
	EpoRpJAK2 = 0.0 
	CISnRNA2 = 0.0 
	CISRNA = 0.0 
