...
#p_ode_problem_names[1] = specC17, p_ode_problem_names[2] = Epo_degradation_BaF3, p_ode_problem_names[3] = k_exp_homo, p_ode_problem_names[4] = k_phos, p_ode_problem_names[5] = ratio, p_ode_problem_names[6] = k_imp_homo, p_ode_problem_names[7] = k_imp_hetero, p_ode_problem_names[8] = k_exp_hetero, p_ode_problem_names[9] = cyt, p_ode_problem_names[10] = nuc
...
function compute_u0!(u0::AbstractVector, p_ode_problem::AbstractVector) 
	...
	STAT5A = 207.6 * p_ode_problem[5] 
	pApA = 0.0 
	nucpApB = 0.0 
	nucpBpB = 0.0 
	STAT5B = 207.6 - 207.6 * p_ode_problem[5] 
	pApB = 0.0 
	nucpApA = 0.0 
	pBpB = 0.0 
